...
import { DbAddAccount } from "@/domain/data/protocols/usecases/add-account/db-add-account"
...
describe('DbAddAccount Usecase', () => {
  ...
  test('Shoul throw if AddAccountRepository throws', async () => {
    const { sut, addAccountRepositoryStub } = makeSut()
    jest.spyOn(addAccountRepositoryStub, 'add').mockReturnValueOnce(new Promise((resolve,
