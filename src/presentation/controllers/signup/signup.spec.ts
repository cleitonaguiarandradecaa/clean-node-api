import { AddAccount, AddAccountModel, AccountModel, HttRequest, Validation } from
  './signup-protocols-controller'
import { MissingParamError, ServerError } from "../../errors"
import { SignUpController } from './signup-controller-controller'
import { ok, serverError, badRequest } from '../../helpers/http/http-helper'
const makeAddAccount = (): AddAccount => {
  class AddAccountStub implements AddAccount { // o termo stub é de email marretado
...
describe('SignUp Controller', () => {
  test('Shoud return 500 if AddAcoount throws', async () => {
